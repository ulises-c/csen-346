...
| Script | Purpose |
|--------|---------|
| `run_eval.sh` | Launch a batch evaluation run for a named experiment |
| `eval_amd_mac.sh` | End-to-end eval: starts AMD teacher locally, runs against Mac Mini consultant |
| `serve_teacher_local.sh` | Serve SocratTeachLLM teacher from local disk |
